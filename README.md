...
flowchart TD
    ...
    subgraph Modeling
        ...
        E --> F{Model Audit<br/>R² / MAPE / Drift}
...
- Между слоями чёткие контракты: сырые данные ↔️ фичи ↔️ прод. Можно переобучить модель, не трогая UI.  
...
## ⚙️ Быстрый старт (когда захотите потрогать код)
```bash
